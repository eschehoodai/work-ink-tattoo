      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-sm text-brand-gray font-normal max-w-md leading-relaxed">
            ...
            <div className="text-xs font-mono-tag text-white/80 font-medium">
          ...
          {/* Col 2: Navigation */}
          <div>
            <h4 className="font-mono-tag text-xs sm:text-sm text-white uppercase tracking-widest mb-4 font-bold">
              STUDIO LINKS
            </h4>
            <ul className="space-y-2.5 text-xs sm:text-sm font-mono-tag">
              <li>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              <a
                href="#"
                className="w-10 h-10 border border-white/20 text-brand-gray hover:border-white hover:text-white flex items-center justify-center transition-colors"
            ...
            <div className="text-xs sm:text-sm font-mono-tag text-brand-gray space-y-1.5">
        ...
        {/* Bottom Bar */}
        <div className="pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs sm:text-sm font-mono-tag text-brand-gray">
          <div>
